...
#define MQTT_DEVICEID "d:hwu:esp32:H00479613"
#define MQTT_USER ""
#define MQTT_TOKEN ""
#define MQTT_TOPIC "d:hwu:esp32:H00479613/evt/status/fmt/json"
#define MQTT_TOPIC_DISPLAY "d:hwu:esp32:H00479613/cmd/display/fmt/json"
#define MQTT_TOPIC_INTERVAL "d:hwu:esp32:H00479613/cmd/interval"
#define MQTT_TOPIC_LED_CONTROL "d:hwu:esp32:H00479613/cmd/led_control"
...
void callback(char* topic, byte* payload, unsigned int length) {payload[length] = 0; // Null-terminate the payload
